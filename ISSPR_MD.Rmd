...
common_subj_id_subset_issp12 <- issp[issp$common_subj_id <3 & issp$experiment<3, 
                                     by= .(common_subj_id)]
...
common_subj_id_subset_ISSPR <- ISSPR_data_without_overlap_metrics[common_subj_id & experiment=4,
                                        by=.(common_subj_id)]
