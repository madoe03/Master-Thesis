...
#issp12_prop_correct$subj_id <-factor(issp12_prop_correct$subj_id)

anov_replay<- ezANOVA(data = , 
        dv = .(), wid = .(), 
        within = .())
```

Here we start with statistic for the orthers N=11; between- subject design
```{r}
