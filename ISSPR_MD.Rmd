...
Here I use stim_dur_ms < 35 instead of stim_dur_ms < 60; then significant effect vanishes, suggesting that it's the longer display durations that make this difference. 'ORIGINAL' 
```{r}
# saccade experiments
common_three_sac <- issp12_prop_correct[(common_subj_id=="01" | common_subj_id=="2" | common_subj_id=="3") &
                                          stim_dur_ms < 35]
