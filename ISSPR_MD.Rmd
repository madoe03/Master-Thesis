...
ISSPR_data_without_overlap_metrics[subj_id=="2", common_subj_id := "1"]

issp[experiment==2 & subj_id=="20", common_subj_id := "2"]
issp[experiment==1 & subj_id=="19", common_subj_id := "2"]
ISSPR_data_without_overlap_metrics[subj_id=="3", common_subj_id := "2"]

issp[experiment==2 & subj_id=="15", common_subj_id := "3"]
issp[experiment==1 & subj_id=="23", common_subj_id := "3"]
ISSPR_data_without_overlap_metrics[subj_id=="7", common_subj_id := "3"]

# here we create only for P. which were included for Experiment 2 and Reply
issp[experiment==2 & subj_id=="3", common_subj_id := "4"]
ISSPR_data_without_overlap_metrics[subj_id=="5", common_subj_id := "4"]

issp[experiment==2 & subj_id=="1", common_subj_id := "5"]
ISSPR_data_without_overlap_metrics[subj_id=="1", common_subj_id := "5"]

issp[experiment==2 & subj_id=="11", common_subj_id := "6"]
ISSPR_data_without_overlap_metrics[subj_id=="4", common_subj_id := "6"]

issp[experiment==2 & subj_id=="12", common_subj_id := "7"]
ISSPR_data_without_overlap_metrics[subj_id=="9", common_subj_id := "7"]

issp[experiment==2 & subj_id=="16", common_subj_id := "8"]
ISSPR_data_without_overlap_metrics[subj_id=="20", common_subj_id := "8"]

issp[experiment==2 & subj_id=="14", common_subj_id := "9"]
ISSPR_data_without_overlap_metrics[subj_id=="8", common_subj_id := "9"]
